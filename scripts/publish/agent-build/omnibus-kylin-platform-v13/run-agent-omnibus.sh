...
case ${1:-} in
  --resume-v9-retry6-post-health)
    echo "v13 is a fresh-build-only control and cannot resume historical v9 work" >&2
    exit 1
    ;;
  --adopt-post-health-v2)
    echo "v13 is a fresh-build-only control and cannot adopt historical v12 work" >&2
    exit 1
    ;;
esac
if (($# > 1)); then
...
build_dir=${BUILD_DIR:-${1:-/home/dbdog/work/dbdog-agent-62ad2979-build1}}
...
control_overlay_rel=control-overlays/62ad29793b02139448b76bc85fc406491a08bf58-7a4247599b029f1aca10d2cb63491d535fbd502f-aarch64-kylin10-v7-omnibus-kylin-platform-v13
...
if [[ "$actual_overlay_inventory" != "$expected_overlay_inventory" ]]; then
    echo "Omnibus control overlay inventory does not match the pinned v13 inventory" >&2
