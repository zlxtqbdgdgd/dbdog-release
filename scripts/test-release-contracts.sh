...
grep -Fq 'expected_rpath="/home/dbdog/work/dbdog-agent-${sha:0:8}-build2/out/$BUILT_ARTIFACT"' \
  "$SCRIPTS_DIR/publish/publish.sh" || fail "Agent 发布器未按发布锚派生 canonical out 路径"
# shellcheck disable=SC2016
