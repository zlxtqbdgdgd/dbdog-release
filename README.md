...
<!-- VERSION-TABLE:BEGIN -->
更新于 2026-08-01 03:40（此表由 publish.sh 生成，权威数据在 manifest.tsv）

| 模块 | 类别 | 装在 | 版本 | 产物 |
| --- | --- | --- | --- | --- |
| dbdog-server | first-party | 全家桶机 | 0.1.10 | dbdog-server-0.1.10-aarch64.tar.gz |
| dbdog-web | first-party | 全家桶机 | 0.1.11 | dbdog-web-0.1.11-aarch64.tar.gz |
| dbdog-mcp | first-party | 全家桶机 | 0.1.8 | dbdog-mcp-0.1.8-noarch.tar.gz |
| dbdog-agent | first-party | DB 主机 | 7.81.0-dbdog.4 | dbdog-agent-7.81.0-dbdog.4-aarch64.tar.gz |
