...
<!-- VERSION-TABLE:BEGIN -->
更新于 2026-09-16 18:08（此表由 publish.sh 生成，权威数据在 manifest.tsv）

| 模块 | 类别 | 装在 | 版本 | 产物 | 架构 |
| --- | --- | --- | --- | --- | --- |
| dbdog-server | first-party | 全家桶机 | 0.1.32 | dbdog-server-0.1.32-aarch64.tar.gz | aarch64 |
| dbdog-web | first-party | 全家桶机 | 0.1.36 | dbdog-web-0.1.36-aarch64.tar.gz | aarch64 |
| dbdog-mcp | first-party | 全家桶机 | 0.1.27 | dbdog-mcp-0.1.27-noarch.tar.gz | noarch |
