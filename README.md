...
<!-- VERSION-TABLE:BEGIN -->
更新于 2026-09-07 23:37（此表由 publish.sh 生成，权威数据在 manifest.tsv）

| 模块 | 类别 | 装在 | 版本 | 产物 | 架构 |
| --- | --- | --- | --- | --- | --- |
| dbdog-server | first-party | 全家桶机 | 0.1.25 | dbdog-server-0.1.25-aarch64.tar.gz | aarch64 |
| dbdog-web | first-party | 全家桶机 | 0.1.28 | dbdog-web-0.1.28-aarch64.tar.gz | aarch64 |
| dbdog-mcp | first-party | 全家桶机 | 0.1.21 | dbdog-mcp-0.1.21-noarch.tar.gz | noarch |
