...
<!-- VERSION-TABLE:BEGIN -->
更新于 2026-09-15 18:02（此表由 publish.sh 生成，权威数据在 manifest.tsv）
...
| dbdog-agent | first-party | DB 主机 | 7.83.0-dbdog.4 | dbdog-agent-7.83.0-dbdog.4-aarch64.tar.gz | aarch64 |
...
| dbdog-agent | first-party | DB 主机 | 7.83.0-dbdog.4 | dbdog-agent-7.83.0-dbdog.4-x86_64.tar.gz | x86_64 |
