...
<!-- VERSION-TABLE:BEGIN -->
更新于 2026-09-07 10:28（此表由 publish.sh 生成，权威数据在 manifest.tsv）
...
| dbdog-agent | first-party | DB 主机 | 7.81.0-dbdog.12 | dbdog-agent-7.81.0-dbdog.12-aarch64.tar.gz | aarch64 |
...
| dbdog-agent | first-party | DB 主机 | 7.81.0-dbdog.12 | dbdog-agent-7.81.0-dbdog.12-x86_64.tar.gz | x86_64 |
<!-- VERSION-TABLE:END -->
