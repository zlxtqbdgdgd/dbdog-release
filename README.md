...
<!-- VERSION-TABLE:BEGIN -->
更新于 2026-09-07 13:24（此表由 publish.sh 生成，权威数据在 manifest.tsv）

| 模块 | 类别 | 装在 | 版本 | 产物 | 架构 |
| --- | --- | --- | --- | --- | --- |
| dbdog-server | first-party | 全家桶机 | 0.1.24 | dbdog-server-0.1.24-aarch64.tar.gz | aarch64 |
| dbdog-web | first-party | 全家桶机 | 0.1.26 | dbdog-web-0.1.26-aarch64.tar.gz | aarch64 |
