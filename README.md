...
<!-- VERSION-TABLE:BEGIN -->
更新于 2026-08-06 21:34（此表由 publish.sh 生成，权威数据在 manifest.tsv）
...
| dbdog-agent | first-party | DB 主机 | 7.81.0-dbdog.6 | dbdog-agent-7.81.0-dbdog.6-aarch64.tar.gz | aarch64 |
