...
<!-- VERSION-TABLE:BEGIN -->
更新于 2026-09-18 00:47（此表由 publish.sh 生成，权威数据在 manifest.tsv）

| 模块 | 类别 | 装在 | 版本 | 产物 | 架构 |
| --- | --- | --- | --- | --- | --- |
| dbdog-server | first-party | 全家桶机 | 0.1.34 | dbdog-server-0.1.34-aarch64.tar.gz | aarch64 |
| dbdog-web | first-party | 全家桶机 | 0.1.38 | dbdog-web-0.1.38-aarch64.tar.gz | aarch64 |
| dbdog-mcp | first-party | 全家桶机 | 0.1.29 | dbdog-mcp-0.1.29-noarch.tar.gz | noarch |
| dbdog-agent | first-party | DB 主机 | 7.83.0-dbdog.7 | dbdog-agent-7.83.0-dbdog.7-aarch64.tar.gz | aarch64 |
...
| dbdog-agent | first-party | DB 主机 | 7.83.0-dbdog.7 | dbdog-agent-7.83.0-dbdog.7-x86_64.tar.gz | x86_64 |
| dbdog-benchweb | first-party | 全家桶机 | 0.1.3 | dbdog-benchweb-0.1.3-aarch64.tar.gz | aarch64 |
<!-- VERSION-TABLE:END -->
