...
<!-- VERSION-TABLE:BEGIN -->
更新于 2026-08-08 22:06（此表由 publish.sh 生成，权威数据在 manifest.tsv）

| 模块 | 类别 | 装在 | 版本 | 产物 | 架构 |
| --- | --- | --- | --- | --- | --- |
| dbdog-server | first-party | 全家桶机 | 0.1.14 | dbdog-server-0.1.14-aarch64.tar.gz | aarch64 |
| dbdog-web | first-party | 全家桶机 | 0.1.17 | dbdog-web-0.1.17-aarch64.tar.gz | aarch64 |
| dbdog-mcp | first-party | 全家桶机 | 0.1.11 | dbdog-mcp-0.1.11-noarch.tar.gz | noarch |
| dbdog-agent | first-party | DB 主机 | 7.81.0-dbdog.8 | dbdog-agent-7.81.0-dbdog.8-aarch64.tar.gz | aarch64 |
