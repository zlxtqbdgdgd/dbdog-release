...
<!-- VERSION-TABLE:BEGIN -->
更新于 2026-09-16 09:06（此表由 publish.sh 生成，权威数据在 manifest.tsv）

| 模块 | 类别 | 装在 | 版本 | 产物 | 架构 |
| --- | --- | --- | --- | --- | --- |
| dbdog-server | first-party | 全家桶机 | 0.1.31 | dbdog-server-0.1.31-aarch64.tar.gz | aarch64 |
| dbdog-web | first-party | 全家桶机 | 0.1.35 | dbdog-web-0.1.35-aarch64.tar.gz | aarch64 |
| dbdog-mcp | first-party | 全家桶机 | 0.1.26 | dbdog-mcp-0.1.26-noarch.tar.gz | noarch |
| dbdog-agent | first-party | DB 主机 | 7.83.0-dbdog.6 | dbdog-agent-7.83.0-dbdog.6-aarch64.tar.gz | aarch64 |
...
| dbdog-agent | first-party | DB 主机 | 7.83.0-dbdog.6 | dbdog-agent-7.83.0-dbdog.6-x86_64.tar.gz | x86_64 |
| dbdog-benchweb | first-party | 全家桶机 | 0.1.2 | dbdog-benchweb-0.1.2-aarch64.tar.gz | aarch64 |
<!-- VERSION-TABLE:END -->
