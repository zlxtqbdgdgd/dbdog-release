...
<!-- VERSION-TABLE:BEGIN -->
更新于 2026-09-18 12:33（此表由 publish.sh 生成，权威数据在 manifest.tsv）

| 模块 | 类别 | 装在 | 版本 | 产物 | 架构 |
| --- | --- | --- | --- | --- | --- |
| dbdog-server | first-party | 全家桶机 | 0.1.38 | dbdog-server-0.1.38-aarch64.tar.gz | aarch64 |
| dbdog-web | first-party | 全家桶机 | 0.1.43 | dbdog-web-0.1.43-aarch64.tar.gz | aarch64 |
| dbdog-mcp | first-party | 全家桶机 | 0.1.29 | dbdog-mcp-0.1.29-noarch.tar.gz | noarch |
| dbdog-agent | first-party | DB 主机 | 7.83.0-dbdog.8 | dbdog-agent-7.83.0-dbdog.8-aarch64.tar.gz | aarch64 |
...
| dbdog-agent | first-party | DB 主机 | 7.83.0-dbdog.8 | dbdog-agent-7.83.0-dbdog.8-x86_64.tar.gz | x86_64 |
| dbdog-benchweb | first-party | 全家桶机 | 0.1.7 | dbdog-benchweb-0.1.7-aarch64.tar.gz | aarch64 |
<!-- VERSION-TABLE:END -->
