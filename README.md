...
<!-- VERSION-TABLE:BEGIN -->
更新于 2026-08-05 21:37（此表由 publish.sh 生成，权威数据在 manifest.tsv）

| 模块 | 类别 | 装在 | 版本 | 产物 | 架构 |
| --- | --- | --- | --- | --- | --- |
| dbdog-server | first-party | 全家桶机 | 0.1.11 | dbdog-server-0.1.11-aarch64.tar.gz | aarch64 |
| dbdog-web | first-party | 全家桶机 | 0.1.13 | dbdog-web-0.1.13-aarch64.tar.gz | aarch64 |
| dbdog-mcp | first-party | 全家桶机 | 0.1.8 | dbdog-mcp-0.1.8-noarch.tar.gz | noarch |
